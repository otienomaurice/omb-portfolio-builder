...
Start with the curated file guides when you want to understand code like a book instead of a line-number report. The expanded server guide is now a 600-plus-page bookmarked PDF book generated by `docs/build_server_book_pdf.py`:
