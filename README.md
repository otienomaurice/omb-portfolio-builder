...
Use **Code** and **Build** for Compile Code workspace actions such as files, folders, imports, testbenches, Save Source, Save As, Beautify, line numbers, append-to-project, Compile, Build project, Run, Synthesize, Simulate, Scope, Syntax, Input, and launching Windows PowerShell at the project workspace. Use **Tools** for system readiness, security reports, compiler/toolchain checks, synthesis diagrams, and asset managers. Use **Preferences** for app viewing themes and Compile Code appearance themes. Use **Help** for customer-facing guide topics and keyboard shortcuts.
