...
Inside a project window, right-click a section or subsection and choose **Open in new tab** or **Open in new window** to keep several project views available at once. Nested subsection chips now use the same compact horizontal navigation style as main project sections, and the right-click menu understands the exact nested path. From that menu you can open the item, open it in a separate project tab or detached project window, copy the project path, add a child subsection, attach a file or image, edit, duplicate, move earlier or later, delete, or clean empty child placeholders. Up to eight project section tabs and up to eight detached project view windows can be open together, and each view keeps its own section/subsection location without changing the main project window.
